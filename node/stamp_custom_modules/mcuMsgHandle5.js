				...
				switch(charger){
					case 'C': //L2 Charger
						...
						switch(msgIdIn){
							...
							//Extracting L2 Data
							case '0':
								L2charger.volt = conv.hexToDec((totalBufIn.slice(10,12).swap16()).toString('hex'));//!Cautious! by doing that you swap 10 12 poitins in totalBufIn itself
								L2charger.curr = conv.hexToDec((totalBufIn.slice(12,14).swap16()).toString('hex'));
								L2charger.powr = conv.hexToDec((totalBufIn.slice(14,16).swap16()).toString('hex'));
								break;
							case '1':
...
module.exports = {mcuMsgDecode,mcuMsgEncode,getMCUData,L2charger,Fcharger};
